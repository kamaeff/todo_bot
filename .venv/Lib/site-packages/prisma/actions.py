...
class UserActions(Generic[_PrismaModelT]):
    ...
    def query_first(
        ...
        *args
        ...
        user = User.prisma().query_first(
            'SELECT * FROM User WHERE updatedAt = $1',
            datetime.datetime.utcnow(),
        )
        ```
        """
    ...
    def find_first(
        ...
        -------
        ```py
        # find the second User record ordered by the chat_id field
    ...
    def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group User records by chat_id values
...
class TodoActions(Generic[_PrismaModelT]):
    ...
    def query_raw(
        ...
        *args
        ...
        users = Todo.prisma().query_raw(
            'SELECT * FROM Todo WHERE createdAt = $1',
            datetime.datetime.utcnow(),
        )
        ```
        """
    ...
    def query_first(
        ...
        *args
        ...
        user = Todo.prisma().query_first(
            'SELECT * FROM Todo WHERE updatedAt = $1',
            datetime.datetime.utcnow(),
        )
        ```
        """
    ...
    def find_many(
        ...
        # find the first 5 Todo records ordered by the id field
    ...
    def find_first(
        ...
        -------
        ```py
        # find the second Todo record ordered by the text field
    ...
    def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Todo record ordered by the userId field
    ...
    def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Todo records by text values
        # and count how many records are in each group
